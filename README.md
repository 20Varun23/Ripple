...
It is highly recommended that the commit message is written seriously. It doesnt have to be elaborate, but it is highly recommended that any information that can help to understand the commit is given in the commit message.
